      ...
      <div>
        ...
        <div className="flex flex-col md:flex-row gap-[60px] items-center justify-center pt-[30px] ">
          <div className="md:basis-[790px]">
            <div className="pb-[25px]">
              <p className="text-[20px] pb-[20px]">
                Download White Paper and Roadmap as .PDF
              </p>
              <div className="flex gap-2 items-center">
                <div>
                  <button className="bg-[#DEAF07] hover:bg-white">
                    White Paper
                  </button>
                </div>
                <div>
            ...
            {/* description */}
            <div>
              <p className="text-[20px] py-[10px] text-[#FFFFFF] ">
                Description
              </p>
              <p className="text-[#FFFEFE] text-[14px]">{cardId[0]?.details}</p>
            </div>
            {/* counter */}
            <div className="flex items-center gap-8 py-[30px]">
              ...
              <div className="flex gap-3">
                <div className="px-3 py-2 w-[47px] h-[45px] text-[20px] bg-[#FCC607] rounded">
                  01{" "}
                </div>
          ...
          <div className="w-full md:w-[300px] p-[30px] md:p-[20px] border border-[#FCC607] rounded">
            <h1 className="text-[#FCC607] text-[32px] text-center">
              {cardId[0]?.title}
            </h1>
            <div className="py-[25px]">
              <div className="flex items-center  justify-between pb-[60px]">
                <div className="flex items-center gap-[15px]">
                  <div>
                    <img
                      className="w-[40px] h-[32px] border border-[#FCC607]"
                      src={cardId[0]?.img}
                      alt=""
                    />
                  </div>
